...
namespace Arrba.Domain.Migrations
{
    ...
    [Migration("20190709085137_AddStatueToCityTable")]
    partial class AddStatueToCityTable
    {
            ...
            modelBuilder.Entity("Arrba.Domain.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastLogin = new DateTime(2019, 7, 9, 11, 51, 37, 4, DateTimeKind.Local).AddTicks(326),
                            ...
                            RegistrationDate = new DateTime(2019, 7, 9, 11, 51, 37, 3, DateTimeKind.Local).AddTicks(2702),
