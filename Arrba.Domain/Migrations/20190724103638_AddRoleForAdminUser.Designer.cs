...
namespace Arrba.Domain.Migrations
{
    ...
    [Migration("20190724103638_AddRoleForAdminUser")]
    partial class AddRoleForAdminUser
    {
            ...
            modelBuilder.Entity("Arrba.Domain.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            ConcurrencyStamp = "52d210ca-b719-4206-b9a7-2a06f9b915fd",
                            Name = "Admin"
                        });
                });
            ...
            modelBuilder.Entity("Arrba.Domain.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastLogin = new DateTime(2019, 7, 24, 13, 36, 37, 639, DateTimeKind.Local).AddTicks(1140),
                            ...
                            RegistrationDate = new DateTime(2019, 7, 24, 13, 36, 37, 638, DateTimeKind.Local).AddTicks(3410),
